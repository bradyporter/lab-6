 ...
 * algorithms.
 * 
 * @author Brady Porter / Whoever wrote the starter code
 */
public class Sorting
{
	...
	public static <T extends Comparable<T>> void insertionSort(T[] data) 
	{
		...
		{ 
			...
			while (moveItem > 0 && data[ moveItem - 1 ].compareTo(insert) >= 1) 
			{           
	 ...
	 */
	//TODO: Make me generic to work on any kind of Comparable data!
	private static <T extends Comparable<T>> void mergeSortHelper(T[] data, int left, int right)
	{
	 ...
	 */
	//TODO: Make me generic to work on any kind of Comparable data!
	private static <T extends Comparable<T>> void merge(T[] data, int left, int middle1, int middle2, int right)
	{
		...
		while (leftIndex <= middle1 && rightIndex <= right)
		{
			...
			if (data[leftIndex].compareTo(data[rightIndex]) == 0
					|| data[leftIndex].compareTo(data[rightIndex]) == -1)
			{
